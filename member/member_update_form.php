...
<head>
  ...
  <!--회원가입폼 스크립트 -->
  <script src="http://<?= $_SERVER['HTTP_HOST'] ?>/php_source/ych_pro/member/js/member_update.js?v=<?= date('Ymdhis') ?>"></script>
  <!-- 공통, 슬라이드, 헤더 스타일 -->
  ...
  <!--회원가입폼 스타일  -->
  <link rel="stylesheet" href="http://<?= $_SERVER['HTTP_HOST'] ?>/php_source/ych_pro/member/css/member.css?v=<?= date('Ymdhis') ?>">
  <!-- 구글폰트 -->
